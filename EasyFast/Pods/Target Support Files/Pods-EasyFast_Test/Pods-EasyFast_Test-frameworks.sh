...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QPDialCodePickerView/QPDialCodePickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YZTagList/YZTagList.framework"
fi
