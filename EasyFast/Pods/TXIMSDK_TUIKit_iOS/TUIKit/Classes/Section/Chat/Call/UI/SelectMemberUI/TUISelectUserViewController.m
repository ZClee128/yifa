...
#import "TUISelectUserViewController.h"
#import "THeader.h"
#import "UIColor+TUIDarkMode.h"
#import "TUISelectUserCell.h"
#import "TUIUserPanelCell.h"
...
@interface TUISelectUserViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UITableViewDelegate,UITableViewDataSource>
...
@implementation TUISelectUserViewController {
...
- (UICollectionView *)userPanel {
    if (!_userPanel.superview) {
        ...
        [_userPanel registerClass:[TUIUserPanelCell class] forCellWithReuseIdentifier:@"TUIUserPanelCell"];
...
- (UITableView *)selectTable {
    if (!_selectTable.superview) {
        ...
        [_selectTable registerClass:[TUISelectUserCell class] forCellReuseIdentifier:@"TUISelectUserCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString* cellIdentifier = @"TUISelectUserCell";
    TUISelectUserCell *cell = (TUISelectUserCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[TUISelectUserCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    static NSString* cellIdentifier = @"TUIUserPanelCell";
    TUIUserPanelCell *cell = (TUIUserPanelCell *)[collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
