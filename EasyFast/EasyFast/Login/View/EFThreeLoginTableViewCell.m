...
//        appleIDBtn.layer.borderColor = RGB16(0xe8e3e3);
...
//            make.left.equalTo(@(left+2*(WidthOfScale(50)+WidthOfScale(30))));
...
//    }
    ...
    for (int i = 0 ; i < titles.count; i++) {
        ...
        if (![titles[i] isEqualToString:@"apple"]) {
            [btn setImage:UIImageMake(titles[i]) forState:(UIControlStateNormal)];
