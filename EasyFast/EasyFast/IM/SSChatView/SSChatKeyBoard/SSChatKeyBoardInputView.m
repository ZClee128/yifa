...
//        [_mLeftBtn addTarget:self action:@selector(btnPressed:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [_mAddBtn setBackgroundImage:[UIImage imageNamed:@"add"] forState:UIControlStateNormal];
        [_mAddBtn setBackgroundImage:[UIImage imageNamed:@"add"] forState:UIControlStateSelected];
        _mAddBtn.selected = NO;
        ...
        [_mSymbolBtn setBackgroundImage:[UIImage imageNamed:@"face"] forState:UIControlStateNormal];
        [_mSymbolBtn setBackgroundImage:[UIImage imageNamed:@"face"] forState:UIControlStateSelected];
...
//        _mTextView.frame = CGRectMake(0, 0, SSChatTextWidth, SSChatTextHeight);
        ...
        [_mTextView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(@(WidthOfScale(10.5)));
            make.size.mas_equalTo(CGSizeMake(WidthOfScale(280), SSChatTextHeight));
            make.centerY.equalTo(self);
        }];
        [_mTextView layoutIfNeeded];
        [_mTextView ViewRadius:5];
        _mTextView.backgroundColor = RGB16(0xF7F7F7);
        _mTextView.returnKeyType = UIReturnKeySend;
        _mTextView.font = RegularFont15;
