...
#define FTDefaultTextColor          tabbarBlackColor
#define FTDefaultMenuFont           RegularFont13
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier menuName:(NSString *)menuName iconImageName:(NSString *)iconImageName
{
    ...
    if (self) {
        ...
        _menuNameLabel.font = RegularFont13;
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.layer.shadowColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:0.7].CGColor;
