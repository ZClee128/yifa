...
-(void)drawRect:(CGRect)rect{
    ...
    lineY = viewHeight - lineWidth - 49.0 - TAB_SAFE_HEIGHT;
    radiu = (viewHeight - TAB_SAFE_HEIGHT - lineWidth * 2) / 2.0;
    
    //1.左边线条
    UIColor *coloerOne = UIColorFromRGBA(0xf5f5f5, 0.5);
    [coloerOne set];
    //圆心到 左右横线的垂直距离
...
//    右边线条
    UIColor *coloerTwo = UIColorFromRGBA(0xf5f5f5, 0.5);
    [coloerTwo set];
...
//    弧线
    UIColor *coloerThree = UIColorFromRGBA(0xf5f5f5, 0.5);
    [coloerThree set];
    CGFloat yyy2 = acos(toTop / radiu);
    CGPoint centerPoint = CGPointMake(viewWidth / 2, (viewHeight - TAB_SAFE_HEIGHT) / 2);
...
//   镂空，去除上边白色部分
    ...
    //获取圆弧所在圆路径
    [ppp appendPath:[UIBezierPath bezierPathWithRoundedRect:CGRectMake((viewWidth - (viewHeight - TAB_SAFE_HEIGHT))/2, 0, (viewHeight - TAB_SAFE_HEIGHT), (viewHeight - TAB_SAFE_HEIGHT)) cornerRadius:radiu]];
